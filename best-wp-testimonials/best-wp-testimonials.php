...
if (!function_exists('bwpt_custom_post_type')) {
                ...
                <div class="testimonial">
                    ...
                    <div class="testimonial-content">
                        <div class="testimonial-profile">
                            ...
                            <span class="post"><?php echo get_post_meta( get_the_ID(), 'testi_desi',true )?></span>
                        </div>
                        <ul class="rating">
    ...
    function bwpt_add_custom_shortcode() {
        add_shortcode( 'TESTIMONIALS', 'bwpt_testimonial_loop' );
    }
    add_action( 'init', 'bwpt_add_custom_shortcode' );
}
//bwpt shortcode
